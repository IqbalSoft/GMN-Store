...
<div class="body-invoice">
  <div class="container py-3">
    <div class="row">
      <a href="<?= base_url($redirect); ?>" class="btn btn-outline-primary text-white"><i class="fa fa-arrow-left"></i> Back</a>
    </div>

    <h3 class="mt-3 text-white">Central Warehouse</h3>

    <form action="" method="post" class="mt-3" id="form-search">
      <div class="row">
        <div class="col-md-4">
          <div class="input-group">
            <input type="text" name="keyword_PC" class="form-control tombol" placeholder="Search" autofocus>
