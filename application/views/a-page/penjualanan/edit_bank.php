<div class="body-invoice b-about">
  <div class="container py-3">
    <div class="card p-3" style="margin-top:6%;">
      <h3 class="text-center text-dark">Edit New Bank
        <hr class="hr">
      </h3>
      <form action="" method="post">
        <div class="bank_name mb-4">
          ...
          <input type="text" name="bank_name" id="name" class="form-control" placeholder="Enter Bank Name" value="<?= strtoupper($edit_bank['bank_name']); ?>">
        ...
        <div class="no-rek mb-3">
          ...
          <input type="text" name="no_rekening" id="no-rek" class="form-control" placeholder="Enter Rekening Number" value="<?= $edit_bank['no_rekening']; ?>">
