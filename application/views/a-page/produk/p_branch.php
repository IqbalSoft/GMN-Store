<div class="container py-3">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="input-group mb-3">
          <input type="text" name="keyword_PB" class="form-control tombol" placeholder="Search">
  ...
  <div class="row mt-3">
    ...
    <div class="col-md-7 col-sm-12 mb-3 mt-3">
      ...
      <a href="<?= base_url('product/central'); ?>" class="btn btn-outline-secondary btn-sm">Central</a>
      <a href="<?= base_url('product/branch'); ?>" class="btn btn-outline-secondary btn-sm active-btn">Branch</a>
    </div>
  </div>
